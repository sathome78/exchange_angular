...
export const AUTH_MESSAGES = {
  ...
  USER_REGISTRATION_NOT_COMPLETED:
    'Seems, that your user is still inactive. Email with activation link has been sent again to your email address. Please, check and follow the instructions.',
